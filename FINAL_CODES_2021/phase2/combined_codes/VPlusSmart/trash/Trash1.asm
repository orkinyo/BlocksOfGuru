...
%define RESET_XCHG 0xF2
%define WRITE_AH (0xE2 + 0x3)
%define WRITE_AL (WRITE_AH + 0x6)
%define PREP_ZOMBS 0xA5
;;
...
add bx,ZOMBIE_START
mov [bx + WRITE_AH - ZOMBIE_START],bh
mov [bx + WRITE_AL - ZOMBIE_START],bl
...
@zomb_prep:
mov byte [bp - 0x1],0x5C
mov word [bp - 0x4],0xE001
add si,(@array - @copy_end)
mov [SHARE_LOC],si

xchg bx,si
add si,(PREP_ZOMBS - ZOMBIE_START)
call si
@zomb_ret:
