...
;; zombie section
mov bp,0x600
mov byte [bp - 0x1],0xDC
xchg bx,[SHARE_LOC]
mov word [bp - 0x4],0xE101
add si,(@zomb_ret - @copy_end)
push si
...
@xchg:
xchg sp,[di - 0x5F00 - 0x1]
xchg dx,[di - 0x5F00 + 0x200 - 0x1]
xchg si,[di - 0x5F00 + 0x400 - 0x1]
xchg ax,[di - 0x5F00 + 0x600 - 0x1]
