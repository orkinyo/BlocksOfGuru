...
lea di,[si - @cf_copy_end + @zombie_start]
...
mov [bx + DELTA_WRITE_LOC_TO_ZOMB],di
mov di,CF_INIT_DI
...
lea bp,[si - INIT_LOOP + ARRAY + 0x100]
mov es,bp
...
mov byte [di - @cf_loop_end - 0x2 + @change_cl + 0x1],((@cf_loop_end - @cf_loop)/0x2 + 0x1)
mov word [di],(ZOMBIE_JUMP_DIST - (@cf_loop_end - @cf_loader) - 0x2 - 0x2)
