...
%define TOP_TRAP_DIST (0x4 * 0x2)
%define BOTTOM_TRAP_DIST (13 * 0x4 + 0x2)
...
mov bx,dx
add bx,(@main_loop - @reset_main_loop - TOP_TRAP_DIST - 0x2)
...
lea di,[bx + 0x2 + TOP_TRAP_DIST + @reset_main_loop - @copy - 0x2]
