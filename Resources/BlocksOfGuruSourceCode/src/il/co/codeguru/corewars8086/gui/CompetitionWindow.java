...
public class CompetitionWindow extends JFrame
	...
	public static String warsPerComb; // $OMB
	public static String seedString; // $OMB
	
	public Competition competition; // $OMB
    private ColumnGraph columnGraph;

    // widgets
    public JButton runWarButton; // $OMB
    ...
    public CompetitionWindow() throws IOException {
		...
		battlesPerGroupField = new JTextField(warsPerComb, 4); // $OMB
		controlPanel.add(battlesPerGroupField);
		seed = new JTextField(15);
		seed.setText(seedString); // $OMB
