...
public class OmegaByteEngine
{
	static String help = "\t--gui\t\t\ton/off - turn on or off competition window (on by default)\n"
			...
			+ "\t--output, -o\t\tFILEPATH - set the scores output file path, .csv extension is added by default,\n\t\t\t\t/ or \\ can be used in the file path (scores by default)\n"
			+ "\t--version, -v\t\tdisplay version\n"
			+ "\t--help, -h\t\tdisplay this help and exit";
	
	static String credits = "Made by OmegaByte members:\nAlon Dayan\nTom Shani";
	...
	public static void main (String args[]) throws IOException
	{
		...
		boolean isGui = true; // $OMB
		boolean isInt86 = true; // $OMB
		boolean isInt87 = false; // $OMB
		int maxRound = 200000; // $OMB
		String warsPerComb = "1000"; // $OMB
		String seed = "guru"; // $OMB
		boolean endOnOneGroup = true; // $OMB
