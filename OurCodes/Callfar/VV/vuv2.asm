...
%define MAGIC_SEG_LOC 0xE901 ;; can be const
%define FIRST_CALLFARIP_LOC 0x55BC ;; must be rand


;; si = ax
mov si,ax

;#waiting for first survivor to calculate segment
nop
nop
nop
;#read from Arena the magicseg
xchg dx, [MAGIC_SEG_LOC]

mov [si+@copy_end],dx

;#waiting for first survivor to calculate first callfarloc
nop
xor ax,ax
;#read from Arena the first callfarloc
xchg ax,[FIRST_CALLFARIP_LOC]
...
add sp,callDist+0x100-0x4			;; sp = ax + calldist
