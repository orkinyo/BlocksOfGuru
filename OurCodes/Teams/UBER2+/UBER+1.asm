...
xchg al,ah
add si,ax
mov ah,[si+@jump_dist_values-@here_is_si]
pop si
mov [0x9999],ah
mov al,0x00 
...
add word [bx + deltaSp_loc],callDist		;; store the value deltaSp in es in some distance after our copied code and callfar loc (according to si so we could do: add sp,[bx+si] in the loop)
