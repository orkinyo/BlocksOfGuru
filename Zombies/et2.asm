...
@loop:
xchg ax,[di + BEAT3_LOC_1 + 0x100]
cmp ax,[di + BEAT3_LOC_2 + 0x100]
jnz @12

xchg ax,[di + BEAT3_LOC_3 + 0x100]
cmp ax,[di + BEAT3_LOC_4 + 0x100]
jnz @34
