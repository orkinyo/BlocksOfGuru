...
%define ZOMB_WRITE_DIST 0x72

mov si,0x98A9
xchg si,ax
lea bx,[si+@array]

mov si,BEAT2_LOC_2 + 0x1
mov bp,BEAT1_LOC_1 + 0x1
...
mov di,BEAT1_LOC_1 + 0x100 + 0x2
mov word [ZOMB_CALL_ADDRESS],bx
...
xor ah,al
mov si,ax
mov word [si+ZOMB_WRITE_DIST],CALL_DI_OPCODE
add di,0x200

loop @loop

mov di,BEAT1_LOC_1 + 0x100 + 0x3
mov cl,0x4
dec dl
jnz @loop
